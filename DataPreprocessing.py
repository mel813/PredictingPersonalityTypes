...
# Note: The target variable is 'Personality' classified as either and the features are all other columns

# Tested dropping stage_fear from the datasetdue to high correlation with Drained_after_socializing, 
